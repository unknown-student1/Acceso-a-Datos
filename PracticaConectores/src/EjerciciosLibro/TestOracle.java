...
public class TestOracle {
    ...
    private static void llenarTablasOracle() {
        try {
            ...
            OracleConnection connection = (OracleConnection) driver.connect(url,props);
            ...
            int filasInsertadasProductos = llenarTablaProductos(connection, insertProductos);
    ...
    private static int llenarTablaClientes(Connection connection, String insertQuery) throws SQLException {
        ...
        try (OraclePreparedStatement preparedStatement = (OraclePreparedStatement) connection.prepareStatement(insertQuery)) {
            // Inserción 1
